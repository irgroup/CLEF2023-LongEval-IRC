...
def main(args):
    ...
    if args.train:
        ...
        run_tag = tag("BM25+LambdaMART_XGB_LETOR-train", "WT")
    else:
        # use the test topics
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="Run BM25+LambdaMART_XGB_LETOR")
    parser.add_argument(
        "--index",
        type=str,
        default="WT",
